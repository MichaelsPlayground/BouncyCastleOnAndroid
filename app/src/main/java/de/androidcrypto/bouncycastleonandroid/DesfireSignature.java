...
public class DesfireSignature {
    ...
    public static String doDesfireSignature() {
        ...
        // see MIFARE DESFire Light Features and Hints AN12343, pages 86 - 88, https://www.nxp.com/docs/en/application-note/AN12343.pdf

        printX("1 Build the EC Public Key");

        String publicKeyNxpDesfireLightShow = "0x040E98E117AAA36457F43173DC920A8757267F44CE4EC5ADD3C54075571AEBBF7B942A9774A1D94AD02572427E5AE0A2DD36591B1FB34FCF3D";
